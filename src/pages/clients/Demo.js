...
export const Demo = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`https://181.215.134.184:5000/api/credit/${id.id}`);
    ...
    useEffect(() => {
        const getNumberInstallation = async () => {
            try {
                const res = await axios.get(`https://181.215.134.184:5000/api/installations_numbers/${idInstallationNumber}`);
    ...
    useEffect(() => {
        const getCompanyData = async () => {
            try {
                const res = await axios.get(`https://181.215.134.184:5000/api/company/${idCompany}`);
    ...
    const getAddressData = async () => {
        try {
            const res = await axios.get(`https://181.215.134.184:5000/api/company/${idCompany}/address`);
    ...
    const makePayment = async () => {
        ...
        return await axios.post(`https://181.215.134.184:5000/api/stripe/payment`, body)
            .then(response => {
