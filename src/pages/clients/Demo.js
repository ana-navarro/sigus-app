...
export const Demo = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`http://sigus-server.vercel.app/api/credit/${id.id}`);
    ...
    useEffect(() => {
        const getNumberInstallation = async () => {
            try {
                const res = await axios.get(`http://sigus-server.vercel.app/api/installations_numbers/${idInstallationNumber}`);
    ...
    useEffect(() => {
        const getCompanyData = async () => {
            try {
                const res = await axios.get(`http://sigus-server.vercel.app/api/company/${idCompany}`);
    ...
    const getAddressData = async () => {
        try {
            const res = await axios.get(`http://sigus-server.vercel.app/api/company/${idCompany}/address`);
    ...
    const makePayment = async () => {
        ...
        return await axios.post(`http://sigus-server.vercel.app/api/stripe/payment`, body)
            .then(response => {
