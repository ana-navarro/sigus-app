...
export const Demo = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`https://sigusminera.online/api/credit/${id.id}`);
    ...
    useEffect(() => {
        const getNumberInstallation = async () => {
            try {
                const res = await axios.get(`https://sigusminera.online/api/installations_numbers/${idInstallationNumber}`);
    ...
    useEffect(() => {
        const getCompanyData = async () => {
            try {
                const res = await axios.get(`https://sigusminera.online/api/company/${idCompany}`);
    ...
    const getAddressData = async () => {
        try {
            const res = await axios.get(`https://sigusminera.online/api/company/${idCompany}/address`);
    ...
    const makePayment = async () => {
        ...
        return await axios.post(`https://sigusminera.online/api/stripe/payment`, body)
            .then(response => {
