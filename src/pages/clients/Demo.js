...
export const Demo = () => {
    ...
    useEffect(() => {
        const getData = async () => {
            try {
                const res = await axios.get(`http://api.sigusminera.online/api/credit/${id.id}`);
    ...
    useEffect(() => {
        const getNumberInstallation = async () => {
            try {
                const res = await axios.get(`http://api.sigusminera.online/api/installations_numbers/${idInstallationNumber}`);
    ...
    useEffect(() => {
        const getCompanyData = async () => {
            try {
                const res = await axios.get(`http://api.sigusminera.online/api/company/${idCompany}`);
    ...
    const getAddressData = async () => {
        try {
            const res = await axios.get(`http://api.sigusminera.online/api/company/${idCompany}/address`);
    ...
    const makePayment = async () => {
        ...
        return await axios.post(`http://api.sigusminera.online/api/stripe/payment`, body)
            .then(response => {
