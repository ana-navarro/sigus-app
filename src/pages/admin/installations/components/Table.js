...
export const Table = ({ data }) => {
    ...
    return (
        <>
            <>
                <HeaderTable>
                    <HeaderTitle>Lista de Instalações:</HeaderTitle>
                    <HeaderAddButton><UnstyleLink to={'/installations/add'}>Adicionar Instalação</UnstyleLink></HeaderAddButton>
                    <Search>
                        <SearchBox
                ...
                <TableRoot>
                    <TableHeadTh>Instalação</TableHeadTh>
                    ...
                    {data.filter((val) => {
                        ...
                        <TableRow key={item._id}>
                            <TableColumn>
                                <Link to={`/installations/${item._id}`}>
