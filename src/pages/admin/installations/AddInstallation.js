...
export const AddInstallation = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("https://181.215.134.184:5000/api/installations_numbers/add", newInstall);
            toast.dismiss();
    ...
    useEffect(() => {
        const fetchTechnical = async () => {
            const res = await axios.get('https://181.215.134.184:5000/api/company/');
