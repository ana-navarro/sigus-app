...
export const AddInstallation = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.post("http://sigusminera.online/api/installations_numbers/add", newInstall);
            toast.dismiss();
    ...
    useEffect(() => {
        const fetchTechnical = async () => {
            const res = await axios.get('http://sigusminera.online/api/company/');
