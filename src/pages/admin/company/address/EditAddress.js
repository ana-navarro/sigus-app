...
export const EditAddress = () => {
    ...
    useEffect(() => {
        const getAddress = async () => {
            try {
                const res = await axios.get(`http://localhost:5000/api/company/${id.idAddress}/address/info`);
    ...
    const handleSubmitEdit = async (id) => {
        ...
        try {
            ...
            const res = await axios.put(`http://localhost:5000/api/company/${id.idAddress}/address/edit`, newAddress);
            toast.dismiss();
