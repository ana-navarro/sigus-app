...
export const EditAddress = () => {
    ...
    useEffect(() => {
        const getAddress = async () => {
            try {
                const res = await axios.get(`http://sigus-server.vercel.app/company/${id.idAddress}/address/info`);
    ...
    const handleSubmitEdit = async (id) => {
        ...
        try {
            ...
            const res = await axios.put(`http://sigus-server.vercel.app/company/${id.idAddress}/address/edit`, newAddress);
            toast.dismiss();
