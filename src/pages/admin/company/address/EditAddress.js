...
export const EditAddress = () => {
    ...
    useEffect(() => {
        const getAddress = async () => {
            try {
                const res = await axios.get(`http://181.215.134.184//api/company/${id.idAddress}/address/info`);
    ...
    const handleSubmitEdit = async (id) => {
        ...
        try {
            ...
            const res = await axios.put(`http://181.215.134.184//api/company/${id.idAddress}/address/edit`, newAddress);
            toast.dismiss();
