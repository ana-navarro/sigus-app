...
export const EditAddress = () => {
    ...
    useEffect(() => {
        const getAddress = async () => {
            try {
                const res = await axios.get(`https://181.215.134.184:5000/api/company/${id.idAddress}/address/info`);
    ...
    const handleSubmitEdit = async (id) => {
        ...
        try {
            ...
            const res = await axios.put(`https://181.215.134.184:5000/api/company/${id.idAddress}/address/edit`, newAddress);
            toast.dismiss();
