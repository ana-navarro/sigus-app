...
export const ShowCredit = () => {
    ...
    const getInstallationNumber = async (id) => {
        try {
            const res = await axios.get(`http://api.sigusminera.online/api/installations_numbers/${id}`)
    ...
    const getAddressData = async (id) => {
        try {
            const res = await axios.get(`http://api.sigusminera.online/api/company/${id}/address`);
    ...
    const getCompanyData = async (id) => {
        try {
            const res = await axios.get(`http://api.sigusminera.online/api/company/${id}`);
    ...
    const getData = async () => {
        try {
            const res = await axios.get(`http://api.sigusminera.online/api/credit/${id.idCredit}`);
            setCredit(res.data);
    ...
    const sendLink = async (e) => {
        e.preventDefault();
        const res = await axios.post(`http://api.sigusminera.online/api/credit/${id.idCredit}/send-demo`, email);
        if (res.status === 201) {
