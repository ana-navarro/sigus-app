...
export const EditCredit = () => {
    ...
    const handleSubmit = async (id) => {
        try {
            ...
            const res = await axios.put(`https://181.215.134.184:5000/api/credit/${id.idCredit}/edit`, updatedCredit);
            toast.dismiss();
    ...
    useEffect(() => {
        const getDataInstall = async () => {
            try {
                const res = await axios.get(`https://181.215.134.184:5000/api/installations_numbers/${idInstallation}`);
