...
export const EditCredit = () => {
    ...
    const handleSubmit = async (id) => {
        try {
            ...
            const res = await axios.put(`https://sigusminera.online/api/credit/${id.idCredit}/edit`, updatedCredit);
            toast.dismiss();
    ...
    useEffect(() => {
        const getDataInstall = async () => {
            try {
                const res = await axios.get(`https://sigusminera.online/api/installations_numbers/${idInstallation}`);
